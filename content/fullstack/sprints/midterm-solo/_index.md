...
| **Functions**                | **Generate Menu Item Function**: Correctly generates a random menu item with name, price, description, and daily special flag for a selected cuisine.                                                     | 5          |
|                              | **Random Cuisine Type Function**: Correctly generates a random cuisine for a restaurant.                                                                                                                  | 5          |
|                              | **Generate Full Menu Function**: Correctly generates a complete menu with 5-10 items for a restaurant, all from the same cuisine.                                                                         | 5          |
| **Functions Total**          |                                                                                                                                                                                                           | **15**     |
| **Unit Tests**               | **Random Menu Item Test**: Unit test verifies proper generation of a random menu item with valid details.                                                                                                 | 5          |
|                              | **Random Cuisine Test**: Unit test verifies correct random generation of a cuisine type.                                                                                                                  | 5          |
|                              | **Full Menu Test**: Unit test verifies correct generation of a full menu with the specified number of items and proper cuisine type.                                                                      | 5          |
| **Unit Tests Total**         |                                                                                                                                                                                                           | **15**     |
